...
import '../presentation/bloc/reaction/reaction_bloc.dart';
...
class DI {
  ...
  static setupLocator() {
    ...
    i.registerLazySingleton(() => ProducerPaymentsBloc());
    i.registerLazySingleton(() => ReactionBloc());
    i.registerLazySingleton(() => CommentBloc());
  }
}
